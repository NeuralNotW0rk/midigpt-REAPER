...
def load_models(task):
    ...
    # unjoined model
    model_path = r'models_section_boundary_experiments_2\unjoined\infill\finetuned_epoch_56_0\model'
    model_path = os.path.join('models_section_boundary_experiments_2', 'unjoined', 'infill', 'finetuned_epoch_56_0', 'model')
